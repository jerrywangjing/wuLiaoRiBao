//
//  WJLoveMovieTableViewController.m
//  无聊日报_Dome
//
...
@interface WJLoveMovieTableViewController ()

//模型数组
@property (nonatomic,strong) NSArray * cellDataArr;
@end

@implementation WJLoveMovieTableViewController
...
-(NSArray * )cellDataArr{
    ...
    if (!_cellDataArr) {
        ...
        // 数据api
        static NSString * apiUrl = @"http://api.wuliaoribao.com/v1/channels/12/items?limit=20&offset=0";
