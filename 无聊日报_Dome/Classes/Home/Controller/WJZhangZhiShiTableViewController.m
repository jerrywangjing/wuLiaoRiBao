//
//  WJZhangZhiShiTableViewController.m
//  无聊日报_Dome
//
...
@interface WJZhangZhiShiTableViewController ()
...
@implementation WJZhangZhiShiTableViewController
...
-(NSArray * )cellDataArr{
    ...
    if (!_cellDataArr) {
        ...
        // 数据api
        static NSString * apiUrl = @"http://api.wuliaoribao.com/v1/channels/16/items?limit=20&offset=0";
